      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-gray-400 hidden md:block">Calimero Secure Environment for Communication</span>
          </div>
        </div>

        <Button variant="ghost" onClick={onAboutClick} className="text-gray-400 hover:text-white">
          About
        </Button>
      </div>
    </header>
