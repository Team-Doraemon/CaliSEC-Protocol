      ...
      <div className="relative z-10">
        ...
        <main className="container mx-auto px-4 py-8 max-w-2xl">
          <div className="bg-[#111111]/80 backdrop-blur-md rounded-2xl p-6 shadow-xl">
            <div className="flex mb-6 bg-[#0A0A0A] rounded-lg p-1">
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-md text-center transition-colors ${
                  activeTab === "deposit" ? "bg-[#1A1A1A] text-white" : "text-gray-400 hover:text-white"
                }`}
              >
                Create Proof
              </button>
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-md text-center transition-colors ${
                  activeTab === "withdraw" ? "bg-[#1A1A1A] text-white" : "text-gray-400 hover:text-white"
                }`}
              >
                Decode Proof
              </button>
            ...
            {activeTab === "deposit" ? (
              <Deposit onDeposit={handleOperation} onComplete={handleOperationComplete} />
            ) : (
              <Withdraw onWithdraw={handleOperation} onComplete={handleOperationComplete} />
            )}
          </div>
        </main>
